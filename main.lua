...
local a a={cache={},load=function(b)if not a.cache[b]then a.cache[b]={c=a[b]()}end return a.cache[b].c end}do function a.a()return{Dark={Name='Dark',Accent='#181818',Outline='#FFFFFF',Text='#FFFFFF',PlaceholderText='#999999'},Light={Name='Light',Accent='#FFFFFF',Outline='#000000',Text='#000000',PlaceholderText='#777777'},Lime={Name='Lime',Accent='#A7F3D0',Outline='#1D4ED8',Text='#1D4ED8',PlaceholderText='#4B5563'},Emerald={Name='Emerald',Accent='#093502',Outline='#034309',Text='#FFFFFFFF',PlaceholderText='#6B7280'},Sky={Name='Sky',Accent='#065e82',Outline='#033f43',Text='#FFFFFF',PlaceholderText='#6B7280'},Rose={Name='Rose',Accent='#500830',Outline='#FFFFFF',Text='#FFFFFF',PlaceholderText='#6B7280'},Amber={Name='Amber',Accent='#F59E0B',Outline='#F97316',Text='#7C2D12',PlaceholderText='#9CA3AF'}}end function a.b()local b={['a-arrow-down']={ImageRectPosition=Vector2.new(0,0),_Size=Vector2.new(96,96),Image=1},['a-arrow-up']={ImageRectPosition=Vector2.new(96,0),_Size=Vector2.new(96,96),Image=1},['a-large-small']={ImageRectPosition=Vector2.new(192,0),_Size=Vector2.new(96,96),Image=1},accessibility={ImageRectPosition=Vector2.new(288,0),_Size=Vector2.new(96,96),Image=1},activity={ImageRectPosition=Vector2.new(384,0),_Size=Vector2.new(96,96),Image=1},['air-vent']={ImageRectPosition=Vector2.new(480,0),_Size=Vector2.new(96,96),Image=1},airplay={ImageRectPosition=Vector2.new(576,0),_Size=Vector2.new(96,96),Image=1},['alarm-clock-check']={ImageRectPosition=Vector2.new(672,0),_Size=Vector2.new(96,96),Image=1},['alarm-clock-minus']={ImageRectPosition=Vector2.new(768,0),_Size=Vector2.new(96,96),Image=1},['alarm-clock-off']={ImageRectPosition=Vector2.new(864,0),_Size=Vector2.new(96,96),Image=1},['alarm-clock-plus']={ImageRectPosition=Vector2.new(0,96),_Size=Vector2.new(96,96),Image=1},['alarm-clock']={ImageRectPosition=Vector2.new(96,96),_Size=Vector2.new(96,96),Image=1},['alarm-smoke']={ImageRectPosition=Vector2.new(192,96),_Size=Vector2.new(96,96),Image=1},album={ImageRectPosition=Vector2.new(288,96),_Size=Vector2.new(96,96),Image=1},['align-center-horizontal']={ImageRectPosition=Vector2.new(384,96),_Size=Vector2.new(96,96),Image=1},['align-center-vertical']={ImageRectPosition=Vector2.new(480,96),_Size=Vector2.new(96,96),Image=1},['align-center']={ImageRectPosition=Vector2.new(576,96),_Size=Vector2.new(96,96),Image=1},['align-end-horizontal']={ImageRectPosition=Vector2.new(672,96),_Size=Vector2.new(96,96),Image=1},['align-end-vertical']={ImageRectPosition=Vector2.new(768,96),_Size=Vector2.new(96,96),Image=1},['align-horizontal-distribute-center']={ImageRectPosition=Vector2.new(864,96),_Size=Vector2.new(96,96),Image=1},['align-horizontal-distribute-end']={ImageRectPosition=Vector2.new(0,192),_Size=Vector2.new(96,96),Image=1},['align-horizontal-distribute-start']={ImageRectPosition=Vector2.new(96,192),_Size=Vector2.new(96,96),Image=1},['align-horizontal-justify-center']={ImageRectPosition=Vector2.new(192,192),_Size=Vector2.new(96,96),Image=1},['align-horizontal-
